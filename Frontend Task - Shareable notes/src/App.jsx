...
const App = () => {
  ...
  const formatInsights = (insights) => {
    const themes = Array.isArray(insights.themes)
      ? insights.themes
      : insights.themes?.split(", ") || [];
    const keywords = Array.isArray(insights.keywords)
      ? insights.keywords
      : insights.keywords?.split(", ") || [];
  ...
  const checkGrammar = async () => {
    ...
    setLoadingGrammar(true); // Start loading
    setIsChecked(true);
    setGrammarIssues([]);
    ...
    try {
      ...
      setLoadingGrammar(false); // Stop loading
    }
  };
              ...
              {selectedNote.password && !showContent ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="mt-4 ml-2 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700"
                  >
                    {loadingGrammar ? (
                      <Spinner  />
                    ) : (
                ...
                <div className="mt-4 p-4 bg-[#D4BEE4] bg-opacity-40 rounded-md">
                  ...
                  <ReactMarkdown>
                    {`**Summary:** ${insights.summary}\n\n**Key Themes:** ${
                      formatInsights(insights).themes
